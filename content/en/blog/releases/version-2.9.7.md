...
A comprehensive changelog detailing all **model** updates in this release is available. The  [detailed changelog](https://github.com/rsyncOSX/RsyncUI/blob/main/documents/ver293_ver297.md) can be accessed at the RsyncUI main repository on GitHub. The changelog is generated by AI after reviewing all Git commits and modifications to the source code.
